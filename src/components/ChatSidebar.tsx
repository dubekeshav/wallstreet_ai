...
const ChatSidebar: React.FC<ChatSidebarProps> = ({
  ...
  return (
    <>
      <div 
        className={`fixed inset-y-0 left-0 z-40 w-72 flex-shrink-0 flex flex-col overflow-hidden transform transition-transform duration-300 ease-in-out bg-gradient-to-b from-indigo-50 to-blue-50 border-r border-blue-200 ${
          isOpen ? 'translate-x-0' : '-translate-x-full'
        } md:translate-x-0`}
      >
        <ChatSidebarHeader onClose={onClose} />
        
        <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-blue-300 scrollbar-track-transparent px-2 py-4">
